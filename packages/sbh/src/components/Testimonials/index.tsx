...
type TestimonialsComponents = {
  ...
  Quote: ComponentOrTag<any>,
  Submitter: ComponentOrTag<any>,
};

export type TestimonialsProps = DesignableComponentsProps<TestimonialsComponents>;
...
const TestimonialsClean: FC<TestimonialsProps> = ({ components: C, ...rest }) => (
...
const asTestimonials = flowHoc(
  designable(testimonialsComponents, 'Testimonials'),
  withDesign({
