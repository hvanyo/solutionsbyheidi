  ...
  return (
    <div>
      <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
        ...
        <li className="ml-4">
          <Link to="http://www.facebook.com/pages/SolutionsbyHeidi#!/pages/SolutionsbyHeidi/114126481958536" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
            <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
